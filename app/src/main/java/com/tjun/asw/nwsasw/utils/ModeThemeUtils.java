...
public class ModeThemeUtils {
    public static final int[][] THEME_ARR = {
    ...
    public static final int[][] THEME_COLOR_ARR = {
    ...
    public static int getTheme(Context context){
        return context.getResources().getColor(THEME_COLOR_ARR[SpUtils.getThemeIndex(context)][0]);
    }
